...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
	...
	if(hge->System_Initiate())
	{
		...
		gui = new hgeGUI;
		gui->AddCtrl(new hgeGUIMenuItem(1, fnt, NULL, 400, 200, 0.0f, "Start Race"));
		gui->AddCtrl(new hgeGUIMenuItem(2, fnt, NULL, 400, 240, 0.1f, "Load Game"));
		gui->AddCtrl(new hgeGUIMenuItem(3, fnt, NULL, 400, 280, 0.2f, "Save Game"));
		gui->AddCtrl(new hgeGUIMenuItem(4, fnt, NULL, 400, 320, 0.3f, "Credits"));
		gui->AddCtrl(new hgeGUIMenuItem(5, fnt, NULL, 400, 360, 0.4f, "Exit"));
